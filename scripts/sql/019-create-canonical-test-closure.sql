...
(
    ...
    CONSTRAINT CK_CurrentTestCase_Posture CHECK (CurrentPosture IN ('CANONICAL_SCENARIO_PROOF','CANONICAL_RESPONSIBILITY_PROOF','KERNEL_CONFORMANCE_PROOF','MECHANIC_FREE_ADAPTER_WIRING_PROOF','PROJECTION_EQUIVALENCE_PROOF','MUTATION_NEGATIVE_CONTROL','REGRESSION_CANDIDATE','DUPLICATE_PROOF','UNBOUND_TEST','OBSOLETE_TEST','EXPERIMENTAL_OR_POTENTIAL_KNOW_HOW'))
);
GO
